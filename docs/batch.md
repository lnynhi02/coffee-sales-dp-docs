...
![Image](img/airflow-connection.png)
![Image](img/spark-connection.png)

All the tasks are defined in the DAG as shown below.
![Image](img/airflow-task.png)
...
## 3. Setup Minio
Go to <a href="http://localhost:9001" target="_blank">localhost:9001</a> to create the necessary buckets.
In this case, create the following buckets: `bronze-layer`, `silver-layer`, and `gold-layer`.
![Image](img/minio-ui.png)

## 4. Run the Batch Pipeline
Now we can execute the DAG
![Image](img/run-dag.png)
